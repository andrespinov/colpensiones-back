...
import com.colpensiones.domain.exceptions.IndependentWorkerNotFoundException;
...
public class IndependentWorkerController {
	...
	IndependentWorker replaceIndependentWorker(@RequestBody IndependentWorker modifiedWorker,
